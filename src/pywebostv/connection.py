...
class WebOSClient(WebOSWebSocketClient):
    ...
    def __init__(self, host):
        self.ws_url = "ws://{}:3000/".format(host)
        print ('ws_url : '+self.ws_url)
        super(WebOSClient, self).__init__(self.ws_url)
        self.waiters = {}
    ...
    def register(self, store, timeout=60):
        ...
        while True:
            ...
            if item.get("payload", {}).get("pairingType") == "PROMPT":
                ...
                print ('client_key = '+store["client_key"])
